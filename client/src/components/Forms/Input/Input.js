...
const Input = (props) => {
    return (
        <Form.Group controlId={props.inputConfig.id}>
            ...
            <Form.Control type={props.inputConfig.type} className={props.inputConfig.error ? "is-invalid":""} name={props.inputConfig.name} placeholder={props.inputConfig.placeholder} value={props.inputConfig.value} onChange={(event) => props.change(event)} />
